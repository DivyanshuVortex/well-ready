...
export default function Home() {
  ...
  const copyCommand = async () => {
    await navigator.clipboard.writeText("npx prisma studio");
    setCopied(true);
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        >
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-300 text-xs font-medium mb-6">
            <Globe className="w-3 h-3 mr-1.5" /> Next.js 15 App Router
          </div>
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            A production-ready template with App Router, Prisma ORM, and Tailwind CSS v4. 
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            {
              title: "Prisma ORM",
              desc: "Type-safe database access with auto-generated query builder.",
              icon: Database,
              color: "text-cyan-400",
              bg: "bg-cyan-500/10"
            },
