...
import { Database, Server, Code2, ArrowRight, Terminal, Check, Copy } from "lucide-react";
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-green-500/30 bg-green-500/10 text-green-300 text-xs font-medium mb-6">
            <Database className="w-3 h-3 mr-1.5" /> MERN Stack (Basic)
          </div>
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            MongoDB, Express, React, Node.js — a classic stack for building modern web applications.
            Simple and powerful.
          </p>
          ...
          {[
            {
              ...
              desc: "Flexible document database with schema validation.",
              icon: Database,
            ...
            },
            {
              ...
              desc: "Robust REST API backend with JavaScript.",
              icon: Server,
              color: "text-blue-400",
              bg: "bg-blue-500/10"
            },
            {
              title: "React & Vite",
              desc: "Modern frontend with fast development experience.",
              icon: Code2,
              color: "text-cyan-400",
              bg: "bg-cyan-500/10"
            }
